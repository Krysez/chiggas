...
const PASS = 'steam_inventory_entitlement_backend_pass_87b';
...
console.log(JSON.stringify({
  ok,
  pass: PASS,
  status: ok ? 'backend_pass_87b_key_diagnostics_check_passed' : 'backend_pass_87b_key_diagnostics_check_failed',
  root: ROOT,
  checks,
  ...
  note: 'Do not paste the full Publisher Web API key into chat again. Rotate it in Steamworks before final release because it was previously exposed.'
}, null, 2));
